        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="glass-effect p-8 rounded-2xl border border-border-theme bg-card-theme/20 flex flex-col gap-6">
              <h3 className="text-xl font-bold text-text-theme">
                Contact Information
              </h3>
              <p className="text-sm text-muted-theme leading-relaxed">
                Feel free to reach out. I typically reply to all messages within
                24 hours.
              </p>
              ...
              <div className="flex flex-col gap-4.5 mt-2">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="block text-[11px] font-semibold text-muted-theme uppercase">
                      Email Me
                    </span>
                    <a
            ...
            <div className="glass-effect rounded-2xl border border-border-theme overflow-hidden h-[240px] relative bg-card-theme/10">
              <iframe
                ...
                src="https://maps.google.com/maps?q=25.5806,85.0846&z=16&output=embed"
